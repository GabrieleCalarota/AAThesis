...
The code is shown in \ref{lst:posnegRCV1CCAT10}, whereas in \ref{fig:rcv1_ccat10_sentiment_analysis} we can see the results that points out Alexander Smith writing more negative articles than David Lawder. Both of the authors wrote the majority of the articles classified as positive than negative.
