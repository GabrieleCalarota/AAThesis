...
\paragraph{}
In \autoref{tab:examplesngram} we can see an example of the n-gram categories ($ n = 3 $) for the sentence \textit{"The actors wanted to see if the pact seemed like an old-fashioned one."}. 
